...
| A1 | `a1-v3/lesson-data/licao-XX.js` e `a1-v3/a1-v3-lesson-registry.js` | `a1-v3/presentation.js` | `a1-v3-data.js`, `a1-v3-cadence-data.js`, editorial legado |
