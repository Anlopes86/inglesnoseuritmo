document.addEventListener('DOMContentLoaded', () => {
    ...
    const modulesData = [
        ...
        { id: 'a1-v3', href: 'a1-v3/a1-v3.html', title: 'M\u00f3dulo A1 V3', lessons: 38, buttonText: 'Testar trilha', icon: 'fa-flask-vial', accent: 'emerald', description: 'Aulas fechadas de 60 minutos com pr\u00e1tica guiada e revis\u00f5es focadas.', isTestVersion: true },
