...
const lessonData = {
    ...
    vestibular: {
        ...
        prompts: { // Prompts de REVISÃO (aula concluída)
            1: `Estou a preparar-me para o vestibular.\nAja como um examinador. O tópico é a estrutura das provas de inglês. Siga estes passos:\n1. Apresente-me uma pequena passagem de um texto típico de vestibular (científico ou jornalístico).\n2. Faça-me uma pergunta de múltipla escolha sobre a ideia geral do texto.\n3. Espere pela minha resposta e explique por que a alternativa correta é a melhor.`,
            2: `Estou a preparar-me para o vestibular.\nAja como meu tutor. O tópico são as técnicas de Skimming e Scanning. Siga estes passos:\n1. Dê-me um texto de 3 parágrafos e um limite de 30 segundos para eu ler (usando a técnica de skimming).\n2. Após os 30 segundos, peça-me para dizer qual é o tema principal do texto.\n3. Depois, peça-me para encontrar (usando scanning) uma data ou um nome específico no texto.\n4. Verifique as minhas respostas.`,
            3: `Estou a preparar-me para o vestibular.\nAja como meu tutor. O tópico é identificar a ideia principal. Siga estes passos:\n1. Apresente-me um parágrafo de um artigo de opinião.\n2. Peça-me para resumir a ideia principal desse parágrafo numa única frase em português.\n3. Analise o meu resumo e dê-me feedback sobre a clareza e precisão.`,
        },
        preview_prompts: { // Prompts de PREPARAÇÃO (próxima aula)
            1: `Estou a preparar-me para o vestibular.\nAja como meu tutor de inglês. Vou começar a estudar para as provas de vestibular. Siga estes passos:\n1. Explique brevemente os 3 tipos mais comuns de questões de inglês no vestibular (Interpretação de Texto, Vocabulário, Gramática).\n2. Dê um exemplo simples para cada tipo.\n3. Pergunte-me em qual dessas áreas eu sinto mais dificuldade.`,
            2: `Estou a preparar-me para o vestibular.\nAja como meu tutor de inglês. A próxima aula será sobre Skimming e Scanning. Siga estes passos:\n1. Explique a diferença entre Skimming (leitura rápida para ideia geral) e Scanning (procura por informação específica).\n2. Dê um exemplo prático: "Para saber o tema de uma notícia, você usa ___. Para encontrar o nome de uma pessoa no texto, você usa ___."\n3. Peça-me para completar as lacunas.`,
            3: `Estou a preparar-me para o vestibular.\nAja como meu tutor de inglês. A próxima aula será sobre como identificar a ideia principal. Siga estes passos:\n1. Explique que a ideia principal (main idea) é a mensagem central do autor.\n2. Dê a dica de que ela geralmente está na primeira ou na última frase do parágrafo.\n3. Dê-me um parágrafo curto e peça para eu tentar sublinhar a frase que contém a ideia principal.`,
        }
    },
    // NOVO MÓDULO DE BUSINESS
    business: {
        titles: [
            "", // Posição 0 vazia
        ...
        prompts: { // Prompts de REVISÃO (aula concluída)
            1: `I'm learning Business English.\nAct as my English career coach. The topic is job interviews. Follow these steps:\n1. Start a mock interview with me by asking the classic question: "So, tell me a little bit about yourself."\n2. Wait for my answer.\n3. Then, ask me a follow-up question about my professional experience, like "Why are you interested in this position?".\n4. After I answer, provide one piece of feedback on my response.`,
            2: `I'm learning Business English.\nAct as a hiring manager. The topic is describing skills. Follow these steps:\n1. Ask me the question: "What are your greatest strengths?".\n2. Wait for my answer.\n3. After I list a strength, ask me to provide a specific example of when I used that skill in a professional situation.\n4. Give me feedback on whether my example was clear and effective.`,
            3: `I'm learning Business English.\nAct as an interviewer. The topic is answering tough questions. Follow these steps:\n1. Ask me a common behavioral question, for example: "Tell me about a time you faced a challenge at work and how you handled it."\n2. Remind me to use the STAR technique (Situation, Task, Action, Result) in my answer.\n3. Wait for my response and evaluate how well I structured it using STAR.`
            // Você pode adicionar os prompts para as outras lições aqui
        },
        preview_prompts: { // Prompts de PREPARAÇÃO (próxima aula)
            1: `I'm preparing for a Business English class about Job Interviews.\nAct as my English tutor. Follow these steps:\n1. Teach me 3 powerful verbs to describe professional achievements (e.g., 'achieved', 'managed', 'implemented').\n2. Give me a clear example for each verb.\n3. Ask me to create a sentence about myself using one of them.\n4. Wait for my answer and give me feedback.`,
            2: `I'm preparing for a Business English class about Describing Skills.\nAct as my English tutor. Follow these steps:\n1. Explain the difference between "hard skills" (technical abilities, like programming) and "soft skills" (interpersonal abilities, like communication).\n2. Give me two examples of each.\n3. Ask me to identify one of my main hard skills and one of my main soft skills.\n4. Wait for my answer.`,
            3: `I'm preparing for a Business English class about Answering Questions using the STAR technique.\nAct as my English tutor. Follow these steps:\n1. Briefly explain what each letter in STAR stands for: Situation, Task, Action, Result.\n2. Give a very simple, one-sentence example for each part (e.g., Situation: "The website was down." Task: "My task was to fix it." etc.).\n3. Ask me which part of STAR I think is the most important for showing my contribution.`,
            // Você pode adicionar os prompts para as outras lições aqui
        }
    }
};
