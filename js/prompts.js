...
- The simple pro/con for each style makes them easy to understand and compare.`,
    ...
    essentials: {
        titles: [
            "", // Posição 0
            "The Foundation: Verb To Be",
            "Daily Life: Simple Present",
            "Right Now: Present Continuous",
            "The Past: Simple Past",
            "Actions in the Past: Past Continuous",
            "Future Plans: Going To & Will",
            "Asking Questions: Question Structure",
            "Abilities & Advice: Can, Could, Should",
            "Describing Places: There is/are & Prepositions",
            "Counting & Quantifying: Quantifiers",
            "Comparisons: Comparatives & Superlatives",
            "Possession: Possessives & 's",
            "Life Experiences: Present Perfect",
            "Verb Combos: Phrasal Verbs",
            "Connecting Ideas: Conjunctions",
            "Rules & Obligations: Must & Have to"
        ],
        prompts: { // Prompts de REVISÃO (aula concluída)
            1: "Estou revisando o Verbo To Be. Aja como meu tutor. Crie um exercício com 5 frases para eu completar com 'am', 'is', ou 'are' (incluindo negativas). Espere minhas respostas e depois corrija-as.",
            2: "Estou revisando o Simple Present. Aja como meu tutor. Dê-me 5 verbos e peça para eu criar uma frase sobre a rotina da 'minha irmã' (she) usando cada um. Verifique se eu usei a regra do '-s' corretamente.",
            3: "Estou revisando o Present Continuous. Aja como meu amigo ao telefone. Descreva uma cena (ex: um parque) e me pergunte o que 3 pessoas diferentes 'estão fazendo' para eu responder usando a estrutura completa.",
            4: "Estou revisando o Simple Past. Aja como meu tutor. Dê-me 5 verbos irregulares no presente (ex: go, see, eat) e peça para eu escrever uma frase sobre 'ontem' (yesterday) com cada um no passado.",
            5: "Estou revisando o Past Continuous. Aja como um detetive. Diga-me 'O crime aconteceu às 20h ontem'. Depois, me pergunte 'O que você estava fazendo (What were you doing) quando isso aconteceu?' e me incentive a dar uma resposta completa.",
            6: "Estou revisando o Futuro. Aja como meu amigo planejando o fim de semana. Faça-me duas perguntas: uma sobre um plano certo (usando 'going to') e outra sobre uma possibilidade (usando 'will').",
            7: "Estou revisando Estrutura de Perguntas. Aja como um jornalista. Dê-me uma resposta (ex: 'She traveled to Japan last year.') e peça para eu criar a pergunta correta usando uma 'Wh-word'.",
            8: "Estou revisando Modais. Aja como meu tutor. Crie 3 situações diferentes e peça para eu dar um conselho para cada uma usando 'should' ou 'shouldn't'.",
            9: "Estou revisando 'There is/are'. Aja como um agente imobiliário. Descreva um cômodo e peça para eu confirmar o que há nele usando 'Is there...?' e 'Are there...?'.",
            10: "Estou revisando Quantificadores. Aja como meu colega de casa fazendo uma lista de compras. Pergunte-me sobre 3 itens contáveis ('how many') e 3 incontáveis ('how much').",
            11: "Estou revisando Comparativos. Aja como meu tutor. Dê-me dois objetos ou pessoas (ex: 'um carro e uma bicicleta') e peça para eu criar uma frase comparando-os usando um adjetivo.",
            12: "Estou revisando Possessivos. Aja como meu tutor. Dê-me uma frase como 'The car of my father is blue.' e peça para eu reescrevê-la de duas formas diferentes (usando 's e adjetivo possessivo).",
            13: "Estou revisando o Present Perfect. Aja como um amigo curioso. Faça-me 3 perguntas sobre experiências de vida usando a estrutura 'Have you ever...?'.",
            14: "Estou revisando Phrasal Verbs. Aja como meu tutor. Dê-me um phrasal verb (ex: 'give up') e peça para eu criar uma frase que demonstre seu significado.",
            15: "Estou revisando Conjunções. Aja como meu tutor. Dê-me duas frases simples e peça para eu conectá-las usando 'and', 'but', 'so' ou 'because'.",
            16: "Estou revisando 'Must/Have to'. Aja como meu chefe. Dê-me 3 regras do 'escritório' e peça para eu reescrevê-las usando 'You must...' ou 'You have to...'."
        },
        preview_prompts: { // Prompts de PREPARAÇÃO (próxima aula)
            1: "Vou aprender o Verbo To Be. Aja como meu tutor. Explique em uma frase para que ele serve e me mostre as 3 formas: 'am', 'is', 'are'. Depois, me peça para completar a frase: 'I ___ a student.'",
            2: "Vou aprender o Simple Present. Aja como meu tutor. Explique que usamos este tempo para rotinas. Dê um exemplo e depois me alerte sobre a 'regra do -s' para 'he/she/it', mostrando um exemplo claro.",
            3: "Vou aprender o Present Continuous. Aja como meu tutor. Explique que usamos este tempo para ações acontecendo 'agora'. Mostre-me a fórmula (to be + verbo-ing) e peça para eu colocar o verbo 'work' nesta forma.",
            4: "Vou aprender o Simple Past. Aja como meu tutor. Explique a regra do '-ed' para verbos regulares. Depois, me avise sobre os 'verbos irregulares' e me dê 3 exemplos importantes (go, have, see).",
            5: "Vou aprender o Past Continuous. Aja como meu tutor. Explique que usamos este tempo para uma 'ação em progresso no passado'. Mostre a fórmula (was/were + verbo-ing) e dê um exemplo claro.",
            6: "Vou aprender sobre o Futuro. Aja como meu tutor. Explique a diferença básica entre 'will' (decisão no momento) e 'going to' (plano) com um exemplo de cada.",
            7: "Vou aprender a fazer perguntas. Aja como meu tutor. Mostre-me a estrutura 'QUASI' (Question Word, Auxiliary, Subject, Infinitive) com um exemplo claro como 'Where did you go?'.",
            8: "Vou aprender sobre modais. Aja como meu tutor. Explique a função de 'can' (habilidade), 'could' (pedido educado) e 'should' (conselho) com um exemplo para cada um.",
            9: "Vou aprender 'There is/are'. Aja como meu tutor. Explique a diferença ('is' para singular, 'are' para plural) e me peça para descrever minha mesa usando uma das duas formas.",
            10: "Vou aprender sobre Quantificadores. Aja como meu tutor. Explique a diferença entre 'much' (incontáveis) e 'many' (contáveis) e me peça para escolher o correto na pergunta: 'How ___ water do you drink?'.",
            11: "Vou aprender sobre Comparativos. Aja como meu tutor. Mostre-me como comparar com adjetivos curtos (-er) e longos (more), com um exemplo de cada.",
            12: "Vou aprender sobre Possessivos. Aja como meu tutor. Mostre-me a diferença entre 'my' e 'mine'. Depois, explique a regra do apóstrofo 's para posse (ex: Maria's book).",
            13: "Vou aprender o Present Perfect. Aja como meu tutor. Explique que usamos este tempo para 'experiências de vida' sem uma data específica. Mostre a estrutura (have + particípio) e dê um exemplo com 'never'.",
            14: "Vou aprender Phrasal Verbs. Aja como meu tutor. Explique o que é um phrasal verb (verbo + preposição = novo significado) e me dê 3 exemplos comuns (get up, turn on, look for).",
            15: "Vou aprender Conjunções. Aja como meu tutor. Mostre-me as 4 conjunções principais (and, but, so, because) e dê um exemplo claro de como 'but' conecta ideias contrastantes.",
            16: "Vou aprender 'Must/Have to'. Aja como meu tutor. Explique a diferença sutil: 'must' é uma obrigação mais pessoal/forte e 'have to' é uma regra externa. Dê um exemplo de cada."
        }
    }
};
