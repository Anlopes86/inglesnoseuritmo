document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadLessons() {
        try {
            ...
            const progress = allProgress['b1-v2'] || {};
            ...
            if (platformAccess && !(platformAccess.canAccessModule(allowedProducts, 'b1-v2') || platformAccess.canAccessModule(allowedProducts, 'b1'))) {
                loadingDiv.textContent = 'Este aluno nao possui acesso ao modulo B1-V2.';
                return;
            }
            ...
            console.error('Erro ao carregar licoes B1-V2:', error);
