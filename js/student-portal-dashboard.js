document.addEventListener('DOMContentLoaded', () => {
    ...
    const MODULES = {
        ...
        'a1-v3': { href: 'a1-v3/a1-v3.html', label: 'Módulo A1 V3', version: 'V3 · teste', family: 'Versão de teste', icon: 'fa-flask-vial', total: 38, helper: 'Aulas prontas de 60 minutos com prática guiada e revisões focadas.' },
