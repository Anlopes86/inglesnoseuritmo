...
[
    'b1-v2-lessons-data.js',
    'b1-v2-lessons-block1a.js',
    'b1-v2-lessons-block1b.js',
    'b1-v2-lessons-block2a.js',
    'b1-v2-lessons-block2b.js',
    'b1-v2-lessons-block3a.js',
    'b1-v2-lessons-block3b.js',
    'b1-v2-lessons-block4a.js',
    'b1-v2-lessons-block4b.js'
].forEach(file => require(path.join(__dirname, '..', 'js', file)));

const lessons = window.B1_V2_LESSONS || [];
const errors = [];
const warnings = [];
...
console.log(`B1-V2 audit: ${lessons.length} lessons, ${errors.length} errors, ${warnings.length} warnings.`);
